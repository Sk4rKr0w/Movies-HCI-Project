        ...
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 min-h-screen p-6">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-6 mt-8 min-h-[60vh]">
                    ...
                    <section className="w-full sm:w-[90%] md:w-[80%] lg:w-2/4 mx-auto lg:mx-0 bg-black/80 backdrop-blur-sm rounded-xl shadow-md flex flex-col justify-start items-start">
                        {/* TAB HEADER */}
                        ...
                        {/* TAB CONTENT */}
                        {activeTab === "proposals" && (
                            <div className="w-full h-full bg-black/80 backdrop-blur-sm rounded-b-xl shadow-md">
                                {group.members.some(
                        ...
                        {activeTab === "seconda" && (
                            <div className="w-full sm:w-[90%] md:w-[80%] lg:w-1/2 mx-auto lg:mx-0 flex-grow bg-black/80 backdrop-blur-sm rounded-xl p-6 shadow-md">
                                <h1 className="text-2xl font-bold text-yellow-400">
                                    Seconda sezione
                                </h1>
                                <p className="text-white mt-2">
                                    Qui puoi inserire il contenuto della seconda
                                    sezione.
                                </p>
                            </div>
                        )}
